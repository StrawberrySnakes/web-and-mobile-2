<?php
    $page = "FairFax_MountainBiking";
    $path="";
    include($path . "inc/header.php");
    include($path . "inc/nav.php");
?>
        <main id="outdoorspagecontent">
            <picture id="historyimg1" class="mainimg">
                    <source media="(max-width: 650px)" srcset="images/history1_img_2.jpg">
                    <img src="images/history1_img.jpg" alt="Historical Protest" class="mainimgtag">
            </picture>
            <h1 class="mainname">History</h1> <!--Add vert line with borders-->

            <section>
                <h2>Introduction</h2>
                <figure class="historyimg2">
                    <img src="images/history2_img.jpg" alt="STS Project"  class="hisimg" id="img2">
                    <figcaption> A communications artifact (Rugby Aerial Tuning Inductor) at the Science Museum, London, UK</figcaption>
                </figure>
                <p>
            ...
            <article id="historyarticle">
                <figure id="historyimg3">
                    <img src="images/history3_img.jpg" alt="History of Psychology objects" class="hisimg" width="100%">
                    <figcaption>exhibit in Museum of Psychology showcasing artifacts from CCHP collections</figcaption>
                </figure>
                
                <h2>Seven intersecting domains of knowledge between STS studies and the field of history of psychology:</h2>
                <ul>
                    <li>The relationship between Psychology, Society and State</li>
                    <li>The history of psychological objects</li>
                    <li>The history of psychological instruments, tools, and technologies</li>
                    <li>historical and epistemological analyses of psychology as a discipline and a profession</li>
                    <li>discussions on reflexivity, constructivism, and historiographic practices</li>
                    <li>quantitative studies such as bibliometric measures, scientometrics, and social network analysis (SNA)</li>
                    <li>research on the professionalization, education, and training in psychology</li>
                </ul>
                <p>
                ...
                <h2>History of instruments, tools, and other technologies</h2>
                <p>
            ...
            <article id="timeline">
                ...
                <section>
                    ...
                    <figure>
                        <!--frameborder="0"-->
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/Bhbl0eDGmsA?si=Dy5s1rb8jjWG1yEM" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> 
                    </figure>
                ...
                <section>
                    <figure>
                        <img src="images/history4_img.jpg" alt="Human using electroencephalogram" class="hisimg" width="100%">
                        <figcaption>TEHRAN (ANA)- Researchers of a knowledge-based company in Iran succeeded in making a conductive gel used to record bioelectrical signals from the patient's skin like the electroencephalogram (EEG) tests.</figcaption>
                    </figure>
                    <section>
                        <h2>Jan 1, 1929</h2>
                        <p>
                ...
                <section>
                    ...
                    <figure>
                        <!--frameborder="0"-->
                        <iframe src="https://www.youtube.com/embed/B10pc0Kizsc?si=HrX7br8Pfb4P5Z4r" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </figure>
                ...
                <section>
                    <figure>
                        <img src="images/history5_img.jpg" alt="MRI brain scans" class="hisimg" width="100%">
                        <figcaption>UCLA Health</figcaption>
                    </figure>
                    <section>
                        <h2>Jan 1, 1973</h2>
                        <p>
                            MRI scans have revolutionized psychology by providing a noninvasive way to study the brain's structure and function in unprecedented detail.
                            MRI scans use a strong magnetic field and radio waves to create detailed images of the brain. They are noninvasive and painless, making them ideal for studying the brain in both healthy people and people with neurological disorders.
                            MRI scans have been used to study a wide range of psychological phenomena, including:
                        </p>
                        <ul>
                            <li>Brain development and maturation</li>
                            <li>Brain aging</li>
                            <li>Brain structure and function in people with mental disorders such as schizophrenia, depression, and anxiety</li>
                            <li>The effects of brain injury</li>
                            <li>The neural basis of cognitive processes such as memory, learning, and decision-making</li>
                        </ul>
                        <p>
                ...
                <section>
                    <section>
                        <h2>Jan 1, 1981</h2>
                        <p>
                            The invention of the personal computer in 1981 had a profound impact on the field of psychology. For the first time, psychologists had access to a powerful tool that could be used to collect and analyze data, develop and test theories, and communicate their findings to the world.
                            Personal computers have made it possible for psychologists to conduct more sophisticated and complex research studies. For example, psychologists can now use computers to create and administer online surveys and experiments, to analyze large datasets, and to simulate complex psychological phenomena.
                ...
                <section>
                    <figure>
                        <img src="images/history7_img.jpg" alt="Picture of Tim Berners-Lee, creator of the World Wide Web" class="hisimg" width="100%">
                        <figcaption>Courtesy Sotheby's</figcaption>
                    </figure>
                    <section>
                        <h2>Jan 1, 1989</h2>
                        <p>
                            The World Wide Web, invented by Tim Berners-Lee in 1989, has revolutionized access to information for psychology students. With the internet, students now have access to a vast library of psychology resources at their fingertips. They can research paper topics, take notes in class, and access journal articles and books from anywhere in the world.
                            This has saved students countless hours that they would have otherwise spent at the university library, manually taking notes. The internet has also made it possible for students to find more specialized psychology information than ever before.
                        </p>
                    </section>
                ...
                <section>
                    ...
                    <figure>
                        <img src="images/history8_img.jpg" alt="fMRI Research" class="hisimg" width="100%">
                        <figcaption>“Functional MRI (Fmri).” Stanford Health Care (SHC) - Stanford Medical Center, 12 Sept. 2017, stanfordhealthcare.org/medical-tests/m/mri/types/fmri.html.</figcaption>
                    </figure>
                ...
                <section>
                    <figure>
                        <img src="images/history9_img.jpg" alt="Internet Graphic" class="hisimg" width="100%">
                        <figcaption>Nagarajan, Madhavan. “How Does the Internet Work?” Medium, 22 Feb. 2019, medium.com/@itIsMadhavan/how-does-the-internet-work-b88c5a000d64. Accessed 16 Nov. 2023.</figcaption>
                    </figure>
                    <section>
                        <h2>Jun 17, 1998</h2>
                        <p>
                            The invention of the internet has revolutionized the way that psychological surveys are conducted. In 1998, there were only 35 online psychology experiments and surveys. Today, thousands of psychology surveys are conducted online every day.
                            Online psychology surveys have several advantages over traditional paper-and-pencil surveys. First, online surveys can be more engaging and interactive. Second, online surveys can be more easily adapted to the individual respondent. For example, online surveys can branch based on the respondent's answers, allowing researchers to ask more relevant questions. Third, online surveys can be more easily analyzed and shared.
                            Online psychology surveys have been used to study a wide range of psychological topics, including personality, intelligence, mental health, and social behavior. They have also been used to develop new psychological interventions and to evaluate the effectiveness of existing interventions.
                        </p>
                    </section>
                ...
                <section>
                    <section>
                        <h2>Jan 1, 2000</h2>
                        <p>
                            The completion of a working draft of the human genome in 2003 was a watershed moment for psychology. It provided a new foundation for understanding the genetic basis of human behavior and mental disorders.
                            Psychologists are now using genomic data to identify the genes that are involved in a wide range of psychological traits and disorders, such as intelligence, personality, depression, and schizophrenia. This research is helping us to better understand how our genes influence our behavior and mental health.
                            For example, researchers have identified several genes that are associated with depression. These genes may play a role in regulating the production of neurotransmitters, which are chemicals that transmit signals between neurons in the brain. Imbalances in neurotransmitters are thought to play a role in depression.
                    ...
                    <figure>
                        <img src="images/history10_img.jpg" alt="The Human Genome" class="hisimg" width="100%">
                        <figcaption>“Large Scientific Collaborations Aim to Complete Human Genome.” The Scientist Magazine®, www.the-scientist.com/features/large-scientific-collaborations-aim-to-complete-human-genome-70423.</figcaption>
                    </figure>
                    
                </section>
            </article>

        <!-- Php here and javascript here-->
